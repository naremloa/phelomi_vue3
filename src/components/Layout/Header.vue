...
import logo from '@/assets/logo/logo_horizon.svg';
...
// const logo = 'https://fakeimg.pl/240x100/?text=logo';

export default {
  components: {
    SocialBtnFacebook, SocialBtnInstagram, SocialBtnLine, SocialBtnWechat, MenuItem,
  },
  setup() {
